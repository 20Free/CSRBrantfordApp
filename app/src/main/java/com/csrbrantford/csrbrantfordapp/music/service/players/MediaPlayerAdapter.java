package com.csrbrantford.csrbrantfordapp.music.service.players;
...
import com.csrbrantford.csrbrantfordapp.music.service.PlaybackInfoListener;
import com.csrbrantford.csrbrantfordapp.music.service.PlayerAdapter;
...
public final class MediaPlayerAdapter extends PlayerAdapter {
    ...
    private static int mMediaLength;

    // Work-around for a MediaPlayer bug related to the behaviour of MediaPlayer.seekTo()
    // while not playing.
     ...
     * created. In the onStop() method of the Music this MediaPlayer is
     * released. Then in the onStart() of the Music a new MediaPlayer
    ...
    protected void onStop() {
        ...
        // be updated, so that the MediaNotificationManager can take down the notification.
    ...
    protected void onPlay() {
        if (mMediaPlayer != null && !mMediaPlayer.isPlaying() && !Music.LIST_ITEM_SELECTED) {
            mMediaPlayer.start();
    ...
    private void setNewState(@PlaybackStateCompat.State int newPlayerState) {
        ...
        // Work around for MediaPlayer.getCurrentPosition() when it changes to not playing.
    ...
    public void seekTo(long position) {
        if (mMediaPlayer != null) {
            ...
            mState = PlaybackStateCompat.STATE_SKIPPING_TO_QUEUE_ITEM;
            // Set the state (to the current state) because the position changed and should
            // be reported to the clients.
            setNewState(mState);
        }
    }
