...
public class AboutCSR extends AppCompatActivity {

    /**
     * Project strings stored in res/values/strings.xml
     *
     * Title bar details stored in res/layout/about_csr_activity.xml
     * Layout details stored in res/layout/about_csr_content.xml
     *
     * Tabs are represented by Fragments and are managed by an AboutCSRPagerAdapter
     *
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.about_csr_activity);
        ...
        final AboutCSRPagerAdapter adapter = new AboutCSRPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
        if (viewPager != null) {
